	...
	static function filter ( $request, $columns, &$bindings )
	{
		...
		if ( $where !== '' ) {
			...
			if(isset($_GET['min']) && isset($_GET['max']) && $_GET['min'] != '' && $_GET['max'] != ''){
		    	$where .= " AND to_date(date, 'DD-MM-YYYY') >= to_date('$_GET[min]', 'YYYY/MM/DD') and to_date(date, 'DD-MM-YYYY') <= to_date('$_GET[max]', 'YYYY/MM/DD')";
			}
		}else{
			if(isset($_GET['min']) && isset($_GET['max']) && $_GET['min'] != '' && $_GET['max'] != ''){
		    	$where = " WHERE to_date(date, 'DD-MM-YYYY') >= to_date('$_GET[min]', 'YYYY/MM/DD') and to_date(date, 'DD-MM-YYYY') <= to_date('$_GET[max]', 'YYYY/MM/DD')";
			}
		}
